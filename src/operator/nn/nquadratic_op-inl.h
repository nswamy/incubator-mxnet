...
#ifndef MXNET_OPERATOR_QUADRATIC_OP_INL_H_
#define MXNET_OPERATOR_QUADRATIC_OP_INL_H_
...
namespace mxnet {
  namespace op {
    struct NQuadraticOpParam : public dmlc::Parameter<NQuadraticOpParam> {
      float a, b, c;

      DMLC_DECLARE_PARAMETER(NQuadraticOpParam) {
    ...
    inline bool NQuadraticOpShape(const nnvm::NodeAttrs &attrs,
    ...
    inline bool NQuadraticOpType(const nnvm::NodeAttrs &attrs,
    ...
    void NQuadraticOpForward(const nnvm::NodeAttrs &attrs,
                            const OpContext &ctx,
      ...
      const NQuadraticOpParam &param = nnvm::get<NQuadraticOpParam>(attrs.parsed);
    ...
    template<typename xpu>
    void NQuadraticOpBackward(const nnvm::NodeAttrs &attrs,
                             const OpContext &ctx,
                             const std::vector<TBlob> &inputs,
                             const std::vector<OpReqType> &req,
                             const std::vector<TBlob> &outputs) {
